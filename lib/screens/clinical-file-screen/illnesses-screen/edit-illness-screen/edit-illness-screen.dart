...
class _EditIllnessScreenState extends State<EditIllnessScreen> {
  ...
  @override
  void initState() {
    illnessNameController.text = widget.illness.name;
    illnessDescriptionController.text = widget.illness.description;
    illnessTypeController.text = widget.illness.type;
    super.initState();
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomDropDownMenu<String>(
                      ...
                      initialSelection: illnessTypeController.text,
                      label: 'نوع المرض',
                      dropDownMenuEntries: [
